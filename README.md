...
[![Version](https://img.shields.io/badge/version-0.9.0-pink.svg)](CHANGELOG.md)
...
1. 下载最新版本：[tarot-confessional-0.9.0.zip](https://github.com/Scott1743/tarot-confessional/releases/download/v0.9.0/tarot-confessional-0.9.0.zip)
...
# 打包 Skill
python3 scripts/package_skill.py --version 0.9.0
